...
namespace LiteDB
{
    ...
    public class ObjectId : IComparable<ObjectId>, IEquatable<ObjectId>
    {
        ...
        static ObjectId()
        {
            //todo: replaced AppDomain.CurrentDomain.Id with 123
            _machine = (GetMachineHash() + 123) & 0x00ffffff;
        ...
        {
            //todo: return Process.GetCurrentProcess().Id;
            return 100;
        }

        private static int GetMachineHash()
        {
            var hostName = Environment.GetEnvironmentVariable("MachineName");
